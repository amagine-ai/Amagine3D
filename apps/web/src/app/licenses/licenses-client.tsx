...
import { curatedLicenses, licensePageCopy } from '../../data/licenses';
...
export function LicensesClient({ packages }: { packages: PackageRecord[] }) {
      ...
      <div className={styles.content}>
        ...
        <section>
          ...
          <div className={styles.downloads}>
            ...
            <a href="/licenses/npm-production-notices.txt">
              {copy.downloadNotices}
            </a>
