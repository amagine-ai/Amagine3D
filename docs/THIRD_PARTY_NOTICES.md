...
| --- | --- | --- | --- |
| OpenAI Codex SDK and runtime | `0.153.4` | Apache-2.0 | [`apache-2.0.txt`](../public/licenses/apache-2.0.txt) |
...
| NetworkX | `3.4.2` | BSD-3-Clause | [`networkx.txt`](../public/licenses/networkx.txt) |
| Manifold | `3.5.2` | Apache-2.0 | [`apache-2.0.txt`](../public/licenses/apache-2.0.txt) |
